...
#   print(ham.E[i], ham.U[:, i])

# print(np.round(np.linalg.inv(ham.U_full) @ ham.H_majoranas @ ham.U_full, 8))
# print(np.round(np.linalg.inv(ham.U_full)@ ham.H_majoranas @ ham.U_full, 8))
# print(np.round(np.conj(ham.U_full.T)@ ham.H_majoranas @ ham.U_full, 8))

# print()
# print(np.round(ham.U_full, 8))

print(f"S_ij = {ham.obs_spinZ_eq(0.0)}")
